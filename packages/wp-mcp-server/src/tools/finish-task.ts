...
import { checkPhpSyntax, CheckPhpSyntaxResult } from './check-php-syntax.js'
import { auditWordPressTheme, AuditResult } from '../utils/standards.js'
 ...
 */
export async function finishTask(options: FinishTaskOptions): Promise<FinishTaskResult> {
