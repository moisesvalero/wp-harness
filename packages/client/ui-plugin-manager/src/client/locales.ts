...
export const zh = {
  ...
  installGuideSafety: '请确认插件来源可信。插件在本机以你的权限运行，来源不明的插件可能损坏 WP Forge，或读取和泄露你的数据。',
  installRun: '安装',
...
export const en = {
  ...
  installGuideSafety: 'Install only plugins you trust: they run with your permissions and can damage WP Forge or leak your data.',
  installRun: 'Install',
