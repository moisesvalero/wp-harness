...
export const en = {
  ...
  creating: 'Creating\u2026',
  welcomeTitle: 'Welcome to WP Forge',
  welcomeBody: 'WP Forge provides an autonomous AI workbench specialized for WordPress engineering, integrating Full Site Editing, coding standards, WebAssembly sandbox verification, and multi-model intelligence.\n\nEnjoy crafting WordPress themes, plugins, and full sites with natural language.',
  welcomeContinue: 'Continue',
  welcomeError: 'The acknowledgement could not be saved. Please try again.',
  onboardingTitle: 'Configure an AI provider to get started',
  onboardingDescription: 'Configure your OpenRouter or preferred AI provider API key to start building.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  create: '创建提供方',
  creating: '创建中\u2026',
  welcomeTitle: '欢迎使用 WP Forge',
  welcomeBody: 'WP Forge 为 WordPress 开发者量身打造自主 AI 工作台，深度融合 Full Site Editing、WordPress 编码规范、WebAssembly 沙箱验证与多模型智能。\n\n欢迎使用自然语言高效构建 WordPress 主题、插件与完整站点。',
  welcomeContinue: '继续',
  welcomeError: '暂时无法保存确认状态，请重试。',
  onboardingTitle: '配置 AI 服务以开始使用',
  onboardingDescription: '配置 OpenRouter 或你首选的 AI 模型密钥，即可开始构建。',
