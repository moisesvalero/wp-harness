...
describe('WelcomeNotice', () => {
  it('uses the exact owner copy in both GUI locales', () => {
    expect(WELCOME_NOTICE_COPY.en).toEqual({
      title: 'Welcome to WP Forge',
      body: 'WP Forge provides an autonomous AI workbench specialized for WordPress engineering, integrating Full Site Editing, coding standards, WebAssembly sandbox verification, and multi-model intelligence.\n\nEnjoy crafting WordPress themes, plugins, and full sites with natural language.',
